...
<div class="container"  style="background-image: url('../imagenes/portadas/audiovi.png'); max-height:100%; max-width: 100%;background-repeat: no-repeat;background-size:cover;background-position:center">
    <div class="row">
      ...
      <div class="col-sm" style="display: table;height:200px;">
        <a style="color:white; text-decoration-line: none; display: table-cell; vertical-align: middle;"><h1>Audiovisual</h1></a>
      </div>
      <div class="col-sm" >
        <br>
        <a href="fotografia.php" style="color:white; text-decoration-line: none;"><h5>Fotografia</h5></a>
        <br>
        <a href="podcast.php" style="color:white; text-decoration-line: none;"><h5>Podcast</h5></a>
        <br>
        <a href="videoreportaje.php" style="color:white; text-decoration-line: none;"><h5>Videoreportaje</h5></a>
      </div>
