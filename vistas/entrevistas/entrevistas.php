...
<section>
 ...
 <main id="main">
    ...
    <!--card  informativos-->
    <section id="enterview" class="mt-4 mb-4">
                ...
                <div class="row"> 
                    <div  class="col-md-8 "> 
                      ...
                      <div  class="card ml-3 mr-3" style="max-width: 100%">
                        <div class="row no-gutters">
                          <div class="col">
                            <img src="images/girl1.jpg" class="card-img" alt="">
                          </div>
                          <div class="col-md-8 col-sm-12 col-12">
                            <div class="card-body ">
                      ...
                      <div  class="card ml-3 mr-3" style="max-width: 100%">
                        <div class="row no-gutters">
                          <div class="col">
                            <img src="images/man2.jpg"  class="card-img"  alt="">
                          </div>
                          <div class="col-md-8 col-sm-12 col-12">
                            <div class="card-body ">
                      ...
                      <div  class="card ml-3 mr-3" style="max-width: 100%">
                        <div class="row no-gutters">
                          <div class="col">
                            <img src="images/girl2.jpg" class="card-img" alt="">
                          </div>
                          <div class="col-md-8 col-sm-12 col-12">
                            <div class="card-body ">
