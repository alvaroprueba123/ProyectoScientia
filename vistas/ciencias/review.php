                  ...
                  <div class="card-body ">
                    <div class="row">
                      ...
                      <div class="ml-3 mr-3">
                        <h2>Review 1</h2>
                        <h5>Juan valdez</h5>
                        <img src="../imagenes/ciencias/review/imgrvw1.jpeg" class="card-img" alt="" style="max-height:100%; max-width:100%;">
                      </div>
                      <!--columanas 2-->
                      <div class="col-sm">
                        <div class="card-body ">
                          <h5 style="float:right;">Review</h5>
                          <br>
                          <p>
                          ...
                          <a class="btn btn-default" style="background:#CCCCCC;" href="../ciencias/review_art.php">Leer más...</a>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="card-body ">
                    <div class="row">
                      ...
                      <div class="ml-3 mr-3">
                        <h2>Review 1</h2>
                        <h5>Juan valdez</h5>
                        <img src="../imagenes/ciencias/review/imgrvw3.jpeg" class="card-img" alt="" style="max-height:100%; max-width:100%;">
                      </div>
                      <!--columanas 2-->
                      <div class="col-sm">
                        <div class="card-body ">
                  ...
                  <div class="card-body ">
                    <div class="row">
                      ...
                      <div class="ml-3 mr-3">
                        <h2>Review 1</h2>
                        <h5>Juan valdez</h5>
                        <img src="../imagenes/ciencias/review/imgrvw2.jpeg" class="card-img" alt="" style="max-height:100%; max-width:100%;">
                      </div>
                      <!--columanas 2-->
                      <div class="col-sm">
                        <div class="card-body ">
