...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no,  maximum-scale=1.0 ,minimun-scale=1.0,user-scalable=no">
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/css/bootstrap.min.css" integrity="sha384-9aIt2nRpC12Uk9gS9baDl411NQApFmC26EwAOH8WgZl5MYYxFfc+NcPb1dKGj7Sk" crossorigin="anonymous">
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css" integrity="sha384-Vkoo8x4CGsO3+Hhxv8T/Q5PaXtkKtu6ug5TOeNV6gBiFeWPGFN9MuhOf23Q9Ifjh" crossorigin="anonymous">
	<meta http-equiv="X-UA-Compatible" content="ie=edge">
    <title>Prueba de Pagina 1 </title>
    ...
    <div class="bgcontainer">
      ...
      <aside id="aside-r">
        ...
        <div id="bloqreco">
          ...
          <div id="">
            La economía golpeada por el coronavirus
          </div>
        </div>
        <div id="bloqreco">
          <div id="imgrecomendaciones">
          ...
          <div id="">
            Protestas en EE.UU se repiten el distintos países
          </div>
        </div>
        <div id="bloqreco">
          <div id="imgrecomendaciones">
